...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}html{scroll-behavior:smooth}body{margin:0;background:#0a0a0a;color:var(--paper);font-family:"BDO Grotesk Variable",Inter,Arial,sans-serif;-webkit-font-smoothing:antialiased;text-rendering:geometricPrecision}
    ...
    .reels-cms{padding:108px 0 120px}.reels-cms-hero{display:grid;grid-template-columns:minmax(0,1fr) minmax(300px,.55fr);gap:24px;align-items:end;border-bottom:1px solid var(--line);padding-bottom:24px;margin-bottom:24px}.reels-cms-hero h2{font-size:clamp(54px,10vw,132px)}.reels-cms-layout{display:grid;grid-template-columns:minmax(0,1fr) 420px;gap:24px;align-items:start}.reel-card-grid{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:16px}.cms-reel-card{border:1px solid var(--line);background:rgba(244,242,237,.04);overflow:hidden;min-width:0;transition:transform .35s cubic-bezier(.16,1,.3,1),border-color .35s,background .35s}.cms-reel-card:hover{transform:translateY(-2px);border-color:rgba(244,242,237,.24);background:rgba(244,242,237,.065)}.cms-reel-media{position:relative;aspect-ratio:9/14;background:#121212;overflow:hidden}.cms-reel-media img,.cms-reel-media video,.cms-reel-media iframe{width:100%;height:100%;object-fit:cover;display:block;border:0;filter:saturate(.88) contrast(1.06);transition:transform .7s cubic-bezier(.16,1,.3,1)}.cms-reel-card:hover .cms-reel-media img,.cms-reel-card:hover .cms-reel-media video,.cms-reel-card:hover .cms-reel-media iframe{transform:scale(1.035)}.cms-reel-body{padding:16px;display:grid;gap:14px}.cms-reel-title{display:grid;gap:8px}.cms-reel-title h3{font-weight:400;font-size:clamp(28px,3.6vw,48px);line-height:.9;letter-spacing:-.07em;margin:0}.cms-reel-title p{margin:0}.new-reel-panel{position:sticky;top:24px}.home-cms{padding:108px 0 120px}.home-cms-hero{display:grid;grid-template-columns:minmax(0,1fr) minmax(300px,.55fr);gap:24px;align-items:end;border-bottom:1px solid var(--line);padding-bottom:24px;margin-bottom:24px}.home-cms-hero h2{font-size:clamp(54px,10vw,132px)}.home-studio-layout{display:grid;grid-template-columns:minmax(0,1fr) 360px;gap:24px;align-items:start}.home-editor-panel{border:1px solid var(--line);background:rgba(244,242,237,.04);padding:18px}.home-editor-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.home-tool-card{border:1px solid var(--line);background:rgba(10,10,10,.36);padding:16px;display:grid;gap:14px;min-width:0}.home-tool-card.full{grid-column:1/-1}.home-tool-card h3{font-weight:400;font-size:clamp(28px,4vw,52px);line-height:.9;letter-spacing:-.07em;margin:0}.home-section-map{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.home-section-chip{border-radius:8px;text-align:left;display:grid;gap:4px;padding:12px;background:rgba(244,242,237,.045);min-height:76px}.home-section-chip:hover{background:rgba(244,242,237,.085);border-color:rgba(244,242,237,.24)}.home-section-chip strong{font-weight:400;color:var(--paper);font-size:14px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.home-section-chip span{color:var(--muted);font-size:12px}.home-element-browser{border:1px solid var(--line);background:rgba(10,10,10,.32);padding:16px;display:grid;gap:14px}.home-element-head{display:flex;align-items:end;justify-content:space-between;gap:14px}.home-element-head h3{font-weight:400;font-size:clamp(28px,4vw,52px);line-height:.9;letter-spacing:-.07em;margin:0}.home-element-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:10px;max-height:520px;overflow:auto;padding-right:4px}.home-element-card{border:1px solid var(--line);background:rgba(244,242,237,.035);border-radius:8px;padding:12px;text-align:left;display:grid;gap:10px;min-height:112px;color:var(--paper)}.home-element-card:hover,.home-element-card.active{background:rgba(244,242,237,.085);border-color:rgba(244,242,237,.26)}.home-element-card strong{font-weight:400;font-size:13px;text-transform:uppercase;letter-spacing:.04em;color:var(--muted)}.home-element-card span{display:-webkit-box;-webkit-line-clamp:3;-webkit-box-orient:vertical;overflow:hidden;line-height:1.22}.home-element-image{width:100%;aspect-ratio:16/10;object-fit:cover;background:#151515;border-radius:6px}.home-selected-section{color:var(--paper)}.home-section-chip.active{background:rgba(244,242,237,.12);border-color:rgba(244,242,237,.28)}.saved-replacements{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:14px}.saved-replacements textarea{min-height:220px}.home-side-panel{position:sticky;top:24px}.home-step-list{display:grid;gap:1px;background:var(--line);margin-top:18px}.home-step-list span{background:rgba(10,10,10,.82);padding:12px;color:var(--muted);font-size:13px}.scan-status{min-height:20px;color:var(--muted);font-size:12px;text-transform:uppercase;letter-spacing:.06em}.work-cms{padding:108px 0 120px}.work-cms-hero{display:grid;grid-template-columns:minmax(0,1fr) minmax(300px,.55fr);gap:24px;align-items:end;border-bottom:1px solid var(--line);padding-bottom:24px;margin-bottom:24px}.work-cms-hero h2{font-size:clamp(54px,10vw,132px)}.cms-stat-strip{display:grid;grid-template-columns:repeat(3,1fr);gap:1px;background:var(--line)}.cms-stat-tile{background:rgba(10,10,10,.86);padding:16px;min-height:118px;display:grid;align-content:space-between}.cms-stat-tile b{font-weight:400;font-size:clamp(34px,5vw,70px);line-height:.86;letter-spacing:-.07em;color:var(--paper)}.work-cms-layout{display:grid;grid-template-columns:minmax(0,1fr) 420px;gap:24px;align-items:start}.project-card-grid{display:grid;grid-template-columns:repeat(2,minmax(0,1fr));gap:16px}.project-card{border:1px solid var(--line);background:rgba(244,242,237,.04);overflow:hidden;min-width:0;transition:transform .35s cubic-bezier(.16,1,.3,1),border-color .35s,background .35s}.project-card:hover{transform:translateY(-2px);border-color:rgba(244,242,237,.24);background:rgba(244,242,237,.065)}.project-card-media{position:relative;aspect-ratio:16/10;background:#121212;overflow:hidden}.project-card-media img{width:100%;height:100%;object-fit:cover;display:block;filter:saturate(.86) contrast(1.05);transition:transform .7s cubic-bezier(.16,1,.3,1)}.project-card:hover .project-card-media img{transform:scale(1.045)}.status-pill{position:absolute;left:12px;top:12px;border:1px solid rgba(244,242,237,.24);background:rgba(10,10,10,.68);backdrop-filter:blur(12px);border-radius:999px;padding:7px 10px;color:var(--paper);font-size:11px;text-transform:uppercase;letter-spacing:.06em}.status-pill.draft{border-color:rgba(219,57,3,.5);color:#ffb39b}.project-card-body{padding:16px;display:grid;gap:14px}.project-card-title{display:grid;gap:8px}.project-card-title h3{font-weight:400;font-size:clamp(30px,4.4vw,58px);line-height:.9;letter-spacing:-.07em;margin:0}.project-card-title p{margin:0}.project-meta{display:grid;grid-template-columns:repeat(2,1fr);gap:1px;background:var(--line);font-size:12px;text-transform:uppercase;letter-spacing:.04em;color:var(--muted)}.project-meta span{background:rgba(10,10,10,.82);padding:10px;min-width:0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.project-card-actions{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.project-card-actions form{display:block;margin-left:auto}.project-edit{margin-top:0;padding:0;background:transparent;border:0}.project-edit summary{display:inline-flex;border:1px solid var(--line);background:rgba(244,242,237,.06);border-radius:999px;padding:10px 14px;font-size:13px;letter-spacing:-.05em}.project-edit[open] summary{background:rgba(244,242,237,.12)}.project-edit[open]::before{content:"";position:fixed;inset:0;z-index:80;background:rgba(0,0,0,.72);backdrop-filter:blur(16px)}.project-edit .cms-form-wrap{position:fixed;left:50%;top:50%;z-index:90;width:min(780px,calc(100vw - 32px));max-height:min(820px,calc(100vh - 32px));overflow:auto;transform:translate(-50%,-50%);border:1px solid rgba(244,242,237,.18);background:rgba(10,10,10,.94);box-shadow:0 30px 100px rgba(0,0,0,.58);padding:18px}.modal-head{display:flex;align-items:end;justify-content:space-between;gap:16px;border-bottom:1px solid var(--line);padding-bottom:14px;margin-bottom:14px}.modal-head h3{font-weight:400;font-size:clamp(30px,5vw,58px);letter-spacing:-.07em;line-height:.9;margin:0}.modal-close{border-color:rgba(244,242,237,.2);background:rgba(244,242,237,.08)}.new-project-panel{position:sticky;top:24px}.empty-state{border:1px solid var(--line);background:rgba(244,242,237,.035);padding:24px;color:var(--muted)}.admin-grid{display:grid;grid-template-columns:minmax(0,1fr) 410px;gap:24px;padding:108px 0 120px}.cms-form{display:grid;gap:18px}.cms-editor-head{display:grid;grid-template-columns:1fr auto;gap:18px;align-items:end;border-bottom:1px solid var(--line);padding-bottom:18px}.cms-editor-head h2{font-size:clamp(38px,6vw,76px)}.cms-fieldset{border:1px solid var(--line);background:rgba(244,242,237,.035);padding:14px;display:grid;gap:14px}.cms-fieldset-title{display:flex;justify-content:space-between;gap:16px;color:var(--paper);font-size:14px;text-transform:uppercase;letter-spacing:.04em}.cms-fieldset-title span{color:var(--muted)}.cms-advanced{border-color:rgba(244,242,237,.16);background:rgba(10,10,10,.28)}.home-section-map{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.home-section-chip{border-radius:8px;text-align:left;display:grid;gap:4px;padding:12px;background:rgba(244,242,237,.045);min-height:76px}.home-section-chip:hover{background:rgba(244,242,237,.085);border-color:rgba(244,242,237,.24)}.home-section-chip strong{font-weight:400;color:var(--paper);font-size:14px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.home-section-chip span{color:var(--muted);font-size:12px}.cms-card-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:14px;padding:28px 0 120px}.cms-card{min-height:260px;display:grid;align-content:space-between;border:1px solid var(--line);background:rgba(244,242,237,.045);padding:18px;transition:transform .35s cubic-bezier(.16,1,.3,1),border-color .35s,background .35s}.cms-card:hover{transform:translateY(-2px);border-color:rgba(244,242,237,.26);background:rgba(244,242,237,.07)}.cms-card h2{font-size:clamp(40px,6vw,72px)}.cms-actions{display:flex;gap:8px;flex-wrap:wrap}.admin-grid>aside{position:sticky;top:24px;align-self:start}label{display:grid;gap:7px;color:var(--muted);font-size:12px;text-transform:uppercase;letter-spacing:.06em}input,textarea,select{width:100%;border:1px solid var(--line);background:rgba(244,242,237,.06);color:var(--paper);padding:12px;border-radius:8px;font:inherit;outline:none}input:focus,textarea:focus,select:focus{border-color:rgba(244,242,237,.34);background:rgba(244,242,237,.085)}textarea{min-height:118px;resize:vertical}form{display:grid;gap:14px}.row{display:grid;grid-template-columns:repeat(2,1fr);gap:12px}.list{display:grid;gap:12px}.item{display:grid;grid-template-columns:120px 1fr auto;gap:14px;align-items:center;border:1px solid var(--line);padding:10px;background:rgba(244,242,237,.035)}.item img{width:120px;aspect-ratio:16/9;object-fit:cover;background:#151515}details{border:1px solid var(--line);padding:14px;margin-top:12px;background:rgba(244,242,237,.035)}summary{cursor:pointer}.danger{background:#34110c;border-color:rgba(219,57,3,.45)}.login{min-height:100vh;display:grid;place-items:center;padding:24px;background:linear-gradient(180deg,rgba(10,10,10,.12),rgba(10,10,10,.85)),url('/assets/local/323795fc9c20f1ac.png') center/cover}.login .panel{width:min(440px,100%)}
    @keyframes riseIn{from{opacity:0;transform:translateY(48px)}to{opacity:1;transform:translateY(0)}}@keyframes wordIn{from{opacity:.001;filter:blur(14px);transform:translateY(30px)}to{opacity:1;filter:blur(0);transform:translateY(0)}}@keyframes posterIn{from{opacity:.001;transform:scale(1.08)}to{opacity:.48;transform:scale(1.04)}}@keyframes tickIn{from{opacity:.001;transform:translateY(120px)}to{opacity:1;transform:translateY(0)}}@keyframes tickDown{from{opacity:.001;transform:translateY(-120px)}to{opacity:1;transform:translateY(0)}}@media(max-width:640px){.work-cms,.home-cms,.reels-cms,.admin-grid{padding-top:88px}.cms-stat-strip,.home-section-map,.timeline,.sheet,.stat-grid,.work-spec-strip{grid-template-columns:1fr}.home-editor-panel,.home-tool-card,.home-element-browser,.panel{padding:14px}.project-edit .cms-form-wrap{width:calc(100vw - 18px);max-height:calc(100vh - 18px);padding:14px}.modal-head{align-items:center}.project-card-actions form{margin-left:0}.cms-reel-media{aspect-ratio:4/5}.topbar .wrap{overflow:auto;justify-content:flex-start}.nav{flex-wrap:nowrap}}@media(max-width:920px){.topbar{bottom:14px}.topbar .wrap{width:calc(100vw - 28px);justify-content:space-between}.hero-row,.split,.admin-grid,.reels-cms-hero,.reels-cms-layout,.reel-card-grid,.home-cms-hero,.home-studio-layout,.home-editor-grid,.home-element-grid,.saved-replacements,.work-cms-hero,.work-cms-layout,.project-card-grid,.row,.case-copy,.reel-grid,.cms-card-grid{grid-template-columns:1fr}.reel-card{min-height:420px}.copy-large{margin:22px 0 0;text-align:left}.timeline,.sheet,.stat-grid,.work-spec-strip,.cms-stat-strip,.home-section-map{grid-template-columns:1fr 1fr}.time-grid{grid-template-columns:repeat(3,1fr)}.time-tick:nth-child(even){display:none}.opening-copy{font-size:clamp(44px,13vw,78px)}.work-row{grid-template-columns:46px 1fr;gap:10px;padding:22px 0}.work-project,.work-year,.work-spec{grid-column:2}.work-thumb{display:none}.item{grid-template-columns:82px 1fr}.item form{grid-column:1/-1}h1{font-size:clamp(68px,24vw,132px)}}
  </style>
...
function homeForm(home = {}) {
  return `<form class="cms-form" method="post" action="/admin/home" enctype="multipart/form-data"><div class="cms-editor-head"><div><div class="eyebrow">Guided home editor</div><h2>Section -> Element -> Change</h2><p>First choose a homepage section. Then click a text or image preview to load it into the editor.</p></div><div><button class="primary" type="button" data-scan-home>Scan Homepage</button><div class="scan-status" data-scan-status>Ready to scan</div></div></div><div class="home-editor-grid"><section class="home-tool-card full"><div class="cms-fieldset-title"><span>01</span><strong>Choose section first</strong></div><label>Selected section<select id="homeSectionFilter"><option value="">All homepage sections</option></select></label><div id="homeSectionMap" class="home-section-map"></div></section><section class="home-tool-card full"><div class="home-element-browser"><div class="home-element-head"><div><div class="eyebrow">02 - Pick element</div><h3>Elements in <span class="home-selected-section" data-selected-section>all sections</span></h3></div><span class="eyebrow" data-element-count>0 elements</span></div><div id="homeElementGrid" class="home-element-grid"></div></div></section><section class="home-tool-card"><div><div class="eyebrow">03A - Text</div><h3>Change Text</h3><p>Click a text element preview above, then type replacement copy.</p></div><label>Selected text<input name="text_from" list="homeTextOptions" placeholder="Click text element above"></label><label>New text<input name="text_to" placeholder="Type replacement text"></label></section><section class="home-tool-card"><div><div class="eyebrow">03B - Image</div><h3>Change Image</h3><p>Click an image preview above, then upload or paste a Google Drive image link.</p></div><label>Selected image URL<input name="image_target" list="homeImageOptions" placeholder="Click image element above"></label><label>New Google Drive image URL<input name="image_url" placeholder="Paste Drive image share link"></label><label>Or upload replacement image<input type="file" name="image" accept="image/*"></label></section><section class="home-tool-card full"><div class="cms-fieldset-title"><span>04</span><strong>Saved replacements</strong></div><div class="saved-replacements"><label>All text replacements<textarea name="text_replacements" placeholder="Anamorph => Your Brand&#10;Book a call => Start a project">${escapeHtml(pairsToText(home.text_replacements || []))}</textarea></label><label>All image replacements<textarea name="image_replacements" placeholder="/assets/local/323795fc9c20f1ac.png => https://drive.google.com/file/d/.../view">${escapeHtml(pairsToText(home.image_replacements || []))}</textarea></label></div></section></div><datalist id="homeTextOptions"></datalist><datalist id="homeImageOptions"></datalist><input type="submit" value="Save home page"><script>(function(){var state={texts:[],images:[],sections:[],selected:''};function clean(v){return (v||'').replace(/\s+/g,' ').trim();}function status(v){var el=document.querySelector('[data-scan-status]');if(el)el.textContent=v;}function sectionName(el){var section=el&&el.closest&&el.closest('section,[data-framer-name],footer,header');if(!section)return 'Global';return section.getAttribute('data-framer-name')||section.id||section.tagName||'Global';}function uniqueItems(items){var seen={};return items.filter(function(item){var key=item.type+'::'+item.section+'::'+item.value;if(seen[key]||!item.value)return false;seen[key]=1;return true;}).slice(0,700);}function activeSection(){return document.getElementById('homeSectionFilter')?.value||'';}function filtered(items){var section=activeSection();return section?items.filter(function(item){return item.section===section;}):items;}function fill(list,items){var el=document.getElementById(list);if(!el)return;el.innerHTML='';filtered(items).forEach(function(item){var option=document.createElement('option');option.value=item.value;option.label=item.section;el.appendChild(option);});}function setActiveCards(){document.querySelectorAll('.home-section-chip').forEach(function(btn){btn.classList.toggle('active',btn.dataset.section===(activeSection()||''));});}function selectSection(section){var select=document.getElementById('homeSectionFilter');if(select)select.value=section||'';state.selected=section||'';setActiveCards();refresh();}function pickElement(item,button){document.querySelectorAll('.home-element-card').forEach(function(card){card.classList.remove('active');});if(button)button.classList.add('active');if(item.type==='text'){var input=document.querySelector('[name="text_from"]');if(input)input.value=item.value;var to=document.querySelector('[name="text_to"]');if(to)to.focus();}else{var input=document.querySelector('[name="image_target"]');if(input)input.value=item.value;var to=document.querySelector('[name="image_url"]');if(to)to.focus();}}function renderElements(){var grid=document.getElementById('homeElementGrid');var label=document.querySelector('[data-selected-section]');var count=document.querySelector('[data-element-count]');if(!grid)return;var section=activeSection();var items=filtered(state.texts).map(function(item){return Object.assign({type:'text'},item);}).concat(filtered(state.images).map(function(item){return Object.assign({type:'image'},item);}));if(label)label.textContent=section||'all sections';if(count)count.textContent=items.length+' elements';grid.innerHTML='';if(!items.length){grid.innerHTML='<div class="empty-state">Scan homepage, then choose a section to see editable elements.</div>';return;}items.forEach(function(item){var button=document.createElement('button');button.type='button';button.className='home-element-card';if(item.type==='image'){button.innerHTML='<strong>Image - '+item.section+'</strong><img class="home-element-image" src="'+item.value.replace(/"/g,'&quot;')+'" alt=""><span>'+item.value+'</span>';}else{button.innerHTML='<strong>Text - '+item.section+'</strong><span>'+item.value+'</span>';}button.addEventListener('click',function(){pickElement(item,button);});grid.appendChild(button);});}function renderSections(){var select=document.getElementById('homeSectionFilter');var map=document.getElementById('homeSectionMap');if(!select||!map)return;select.innerHTML='<option value="">All homepage sections</option>';state.sections.forEach(function(section){var option=document.createElement('option');option.value=section;option.textContent=section;select.appendChild(option);});map.innerHTML='';state.sections.forEach(function(section){var textCount=state.texts.filter(function(item){return item.section===section;}).length;var imageCount=state.images.filter(function(item){return item.section===section;}).length;var button=document.createElement('button');button.type='button';button.className='home-section-chip';button.dataset.section=section;button.innerHTML='<strong>'+section+'</strong><span>'+textCount+' text / '+imageCount+' image</span>';button.addEventListener('click',function(){selectSection(section);});map.appendChild(button);});setActiveCards();}function refresh(){fill('homeTextOptions',state.texts);fill('homeImageOptions',state.images);renderElements();}async function scan(){status('Scanning homepage');try{var res=await fetch('/',{cache:'no-store'});var html=await res.text();var doc=new DOMParser().parseFromString(html,'text/html');var blocked={SCRIPT:1,STYLE:1,NOSCRIPT:1};var texts=[];var walker=doc.createTreeWalker(doc.body,NodeFilter.SHOW_TEXT,{acceptNode:function(node){var parent=node.parentElement;if(!parent||blocked[parent.tagName])return NodeFilter.FILTER_REJECT;var text=clean(node.nodeValue);return text.length>1&&text.length<220?NodeFilter.FILTER_ACCEPT:NodeFilter.FILTER_REJECT;}});while(walker.nextNode()){texts.push({type:'text',value:clean(walker.currentNode.nodeValue),section:sectionName(walker.currentNode.parentElement)});}var images=[];doc.querySelectorAll('img').forEach(function(img){var section=sectionName(img);var src=img.getAttribute('src');if(src)images.push({type:'image',value:src,section:section});(img.getAttribute('srcset')||'').split(',').forEach(function(part){var first=part.trim().split(/\s+/)[0];if(first)images.push({type:'image',value:first,section:section});});});state.texts=uniqueItems(texts);state.images=uniqueItems(images);state.sections=Array.from(new Set(state.texts.concat(state.images).map(function(item){return item.section;}))).filter(Boolean);renderSections();refresh();status(state.sections.length+' sections scanned - choose section');}catch(e){status('Scan failed - refresh and try again');}}document.getElementById('homeSectionFilter')?.addEventListener('change',function(){state.selected=activeSection();setActiveCards();refresh();});document.querySelector('[data-scan-home]')?.addEventListener('click',scan);scan();})();</script></form>`;
}
...
function adminHomePage(data) {
  const home = data.home || {};
  const textCount = (home.text_replacements || []).length;
  const imageCount = (home.image_replacements || []).length;
  return shell("Home CMS - Anamorph", `${adminNav("home")}<main class="wrap home-cms"><section class="home-cms-hero"><div><div class="eyebrow">(CMS) - Home Page</div><h2>Homepage Studio</h2><p>Edit homepage copy and visuals while the original Framer design, layout, and animation stay locked in place.</p></div><div class="cms-stat-strip"><div class="cms-stat-tile"><span class="eyebrow">Text swaps</span><b>${textCount}</b></div><div class="cms-stat-tile"><span class="eyebrow">Image swaps</span><b>${imageCount}</b></div><div class="cms-stat-tile"><span class="eyebrow">Mode</span><b>Live</b></div></div></section><section class="home-studio-layout"><div class="home-editor-panel">${homeForm(home)}</div><aside class="panel glass home-side-panel"><div class="eyebrow">(Preview)</div><h2>Home</h2><p>Scan the homepage first, choose the section, then save one replacement at a time or edit the saved lists directly.</p><div class="cms-actions"><a class="pill primary" href="/">Open Home</a><a class="pill" href="/#reels">Home Reels</a></div><div class="home-step-list"><span>01 - Scan live homepage</span><span>02 - Pick section and item</span><span>03 - Save and refresh site</span></div></aside></section></main>`);
}
...
function adminReelsPage(data) {
  ...
  const published = reels.filter((r) => r.published !== false).length;
  const drafts = reels.length - published;
  const homepageSlots = Math.min(published, 3);
  const cards = reels.map((r, i) => {
    const status = r.published === false ? "Draft" : "Published";
    const statusClass = r.published === false ? " draft" : "";
    const media = mediaHtml({ ...r, image: r.image || '/assets/local/323795fc9c20f1ac.png' }, "card");
    return `<article class="cms-reel-card"><div class="cms-reel-media">${media}<span class="status-pill${statusClass}">${status}</span></div><div class="cms-reel-body"><div class="cms-reel-title"><div class="eyebrow">${String(i + 1).padStart(2, "0")} - /${escapeHtml(r.slug || '')}</div><h3>${escapeHtml(r.title || 'Untitled reel')}</h3><p>${escapeHtml(r.caption || 'Homepage reel slot')}</p></div><div class="project-meta"><span>${escapeHtml(r.duration || '00:15')}</span><span>${escapeHtml(r.format || '9:16 Reel')}</span></div><div class="project-card-actions"><a class="pill primary" href="/reels">Preview</a><details class="project-edit"><summary>Edit</summary><div class="cms-form-wrap"><div class="modal-head"><div><div class="eyebrow">Edit Reel</div><h3>${escapeHtml(r.title || 'Reel')}</h3></div><button class="modal-close" type="button" onclick="this.closest('details').open=false">Close</button></div>${reelForm(r)}</div></details><form method="post" action="/admin/reels/delete" onsubmit="return confirm('Delete this reel?')"><input type="hidden" name="id" value="${escapeHtml(r.id || '')}"><button class="danger">Delete</button></form></div></div></article>`;
  }).join("");
  return shell("Reels CMS - Anamorph", `${adminNav("reels")}<main class="wrap reels-cms"><section class="reels-cms-hero"><div><div class="eyebrow">(CMS) - Home Reels</div><h2>Reel Library</h2><p>Change the short-form videos used on the reels page and the first three published home page reel slots.</p></div><div class="cms-stat-strip"><div class="cms-stat-tile"><span class="eyebrow">Reels</span><b>${reels.length}</b></div><div class="cms-stat-tile"><span class="eyebrow">Published</span><b>${published}</b></div><div class="cms-stat-tile"><span class="eyebrow">Home slots</span><b>${homepageSlots}</b></div></div></section><section class="reels-cms-layout"><div class="reel-card-grid">${cards || '<div class="empty-state">No reels yet. Upload the first homepage video from the panel on the right.</div>'}</div><aside class="panel glass new-reel-panel"><div class="eyebrow">(Upload) - Home Reel Video</div><h2>New Reel</h2><p>Upload a local video, paste a YouTube link, or add a Drive poster. The first three published reels are used on the homepage.</p>${reelForm()}<div class="cms-actions" style="margin-top:14px"><a class="pill primary" href="/reels">Preview Reels</a><a class="pill" href="/#reels">Preview Home</a></div></aside></section></main>`);
}
