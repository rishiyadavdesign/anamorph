...
function workIndex(projects) {
  ...
  return shell("Selected Work - Anamorph", `<header class="topbar"><div class="wrap"><a class="brand" href="/">Anamorph</a><nav class="nav"><a class="pill" href="/">Home</a><a class="pill primary" href="/work">Work</a><a class="pill" href="/admin">CMS</a></nav></div></header><main><section class="opening"><div class="time-grid"><div class="time-tick"><span>00:00</span><span class="rule"></span><span class="plus">+</span><span class="rule"></span></div><div class="time-tick"><span>00:30</span><span class="rule"></span><span class="plus">+</span><span class="rule"></span></div><div class="time-tick"><span>01:00</span><span class="rule"></span><span class="plus">+</span><span class="rule"></span></div><div class="time-tick"><span>01:30</span><span class="rule"></span><span class="plus">+</span><span class="rule"></span></div><div class="time-tick"><span>02:00</span><span class="rule"></span><span class="plus">+</span><span class="rule"></span></div></div><div class="wrap"><h1 class="opening-copy">Everything that left<br><span>this room cut by cut</span></h1><div class="work-count"><b>${projects.length} Films - 2025-2026</b><span>00:02:00:00</span></div></div></section><section class="wrap section-head"><div><div class="eyebrow">(02) - All Work</div><h2>Selected Work</h2></div><a class="pill primary" href="/admin">Upload Project</a></section><section class="wrap work-list">${rows || "<p>No projects published yet.</p>"}</section><section class="wrap next-link"><div><div class="eyebrow">(03) - Booking</div><h2>Let's roll</h2></div><a class="pill primary" href="/admin">Add Work</a></section></main>`);
}
